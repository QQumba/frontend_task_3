...
function createItemBlock(phone){
	...
	let ratingRevievs = document.createElement('p');
	ratingRevievs.innerText = phone.ratingRevievs;
	item.appendChild(ratingRevievs);

	if(phone.price.oldUan == undefined){
		...
		newPrice.innerText = phone.price.newUan;
		newPrice.classList.add('price');
		newPrice.classList.add('new-price');
		priceBlock.appendChild(newPrice);

		let oldPrice = document.createElement('p');
		oldPrice.innerText = phone.price.oldUan;
...
function displayData(phoneInfoArray){
	phoneInfoArray.forEach(phoneInfo => createItemBlock(phoneInfo));
}
